...
- [ ] `computeInsertPosition(null, 1000)` retorna `999`
- [ ] `computeInsertPosition(1000, null)` retorna `1001`
- [ ] `computeInsertPosition(1000, 2000)` retorna `1500`
- [ ] `shouldRenumber` retorna `true` quando diferença entre adjacentes < `1e-9`
- [ ] `touchBoard` atualiza `updatedAt` do board dentro da transaction recebida
- [ ] Testes unitários para `computeInsertPosition` e `shouldRenumber` passando
